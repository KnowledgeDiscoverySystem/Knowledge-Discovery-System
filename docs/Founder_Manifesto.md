...
These words have no place in safety‑critical modernization.

KDS rejects nondeterminism.
It rejects hallucination.
It rejects ambiguity.

If a transformation cannot be proven, traced, or justified, it does not enter the system.
